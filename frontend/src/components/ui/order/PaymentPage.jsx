...
import { clearIdOfReOrders } from "../../../features/orderSlice";
            ...
            <section className=" w-4/6 flex justify-center items-start mx-auto mt-5">
                <div className="flex flex-col w-3/5 ">
                    ...
                    <div className="flex flex-col border rounded-xl">
                        ...
                        <p className="py-5 px-6">
                            <NavLink to={`/stripe-checkout/${orderId || currentOrderId}`}>Credit / Debit Card</NavLink>
                            </p>
                        <hr></hr>
                ...
                <div className=" h-full !w-2/6 border ml-5 ">
                    <div className="!py-5 !px-6 flex flex-col !w-full ">
                        ...
                        <p className="text-xs mt-[6px]">{localStorage.getItem('deliveryAddress')}</p>
                        :
          
          <p className="text-xs mt-[6px]">No delivery location selected</p>
...
function Header(){
    ...
    return (
        ...
        <div className="flex flex-1 justify-center items-center h-full" onClick={(e)=>{
                    e.preventDefault();
                    navigate("/");
                }}>
